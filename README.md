Here is the formatted README file in a copy-pasteable code block.

````markdown
# ASTE 583 Project – Lunar Trailblazer Navigation

**Repository:** `totesirfan-aste_583_project_irfan_can`  
**Course:** ASTE 583 – Navigation & Estimation  
...
### 5.3 Phase 2 (Preliminary)
  ...
  - **`Phase2_Prelim_Batch.m`**: 10-state Batch LS over 0–6 days. Solves for state, k\_SRP, bias, and Station 4 coordinates.
